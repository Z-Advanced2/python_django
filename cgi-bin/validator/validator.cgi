#!/release/tools/validator/online/Django/djangopj_venv/bin/python
# encoding: utf-8
"""
django-.cgi
...
sys.path.append("/release/tools/validator/online/Django/djangopj_venv/lib/python3.7/site-packages")
sys.path.append("/release/tools/validator/online/Django/django_validator")
...
os.environ['DJANGO_SETTINGS_MODULE'] = 'django_validator.settings'
